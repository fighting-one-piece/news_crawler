...
from news.items import NeteaseEntNewsItem, NeteaseEntNewsDetailItem
...
class NeteaseEntNewsSpider(CrawlSpider):

    name = "netease_ent_news_spider"
    allowed_domains = ["163.com", "ent.163.com"]
    redis_key = "netease_ent_news_spider"
    start_urls = [
        'https://ent.163.com/special/000380VU/newsdata_index.js?callback=data_callback',
        'https://ent.163.com/special/000380VU/newsdata_movie.js?callback=data_callback',
        'https://ent.163.com/special/000380VU/newsdata_tv.js?callback=data_callback',
        'https://ent.163.com/special/000380VU/newsdata_show.js?callback=data_callback',
        'https://ent.163.com/special/000380VU/newsdata_music.js?callback=data_callback'
    ]
