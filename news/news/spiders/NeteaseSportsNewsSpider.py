...
from news.items import NeteaseSportsNewsItem, NeteaseSportsNewsDetailItem
...
class NeteaseSportsNewsSpider(CrawlSpider):

    name = "netease_sports_news_spider"
    allowed_domains = ["163.com", "sports.163.com"]
    redis_key = "netease_sports_news_spider"
    start_urls = [
        'https://sports.163.com/special/000587PR/newsdata_n_index.js?callback=data_callback',
        'https://sports.163.com/special/000587PR/newsdata_n_nba.js?callback=data_callback',
        'https://sports.163.com/special/000587PR/newsdata_n_world.js?callback=data_callback',
        'https://sports.163.com/special/000587PR/newsdata_n_china.js?callback=data_callback',
        'https://sports.163.com/special/000587PR/newsdata_n_cba.js?callback=data_callback',
        'https://sports.163.com/special/000587PR/newsdata_n_allsports.js?callback=data_callback'
    ]
    ...
    def parse(self, response):
        ...
        if not response_body.strip().startswith('data_callback'):
            ...
            item = NeteaseSportsNewsDetailItem()
