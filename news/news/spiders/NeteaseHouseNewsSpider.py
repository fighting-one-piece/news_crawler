...
from news.items import NeteaseHouseNewsItem, NeteaseHouseNewsDetailItem
...
class NeteaseHouseNewsSpider(CrawlSpider):

    name = "netease_house_news_spider"
    allowed_domains = ["163.com", "house.163.com"]
    redis_key = "netease_house_news_spider"
    start_urls = [
        'https://cd.house.163.com/special/022498HF/cd_float_yuanchuang.js?callback=data_callback',
        'https://cd.house.163.com/special/022498HF/cd_float_daogou.js?callback=data_callback'
    ]
    ...
    def parse(self, response):
        ...
        if not response_body.strip().startswith('data_callback'):
            ...
            item = NeteaseHouseNewsDetailItem()
