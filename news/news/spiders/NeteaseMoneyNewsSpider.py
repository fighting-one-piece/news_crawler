...
from news.items import NeteaseMoneyNewsItem, NeteaseMoneyNewsDetailItem
...
class NeteaseMoneyNewsSpider(CrawlSpider):

    name = "netease_money_news_spider"
    allowed_domains = ["163.com", "money.163.com"]
    redis_key = "netease_money_news_spider"
    start_urls = [
        ...
        'https://money.163.com/special/00259BVP/news_flow_car.js?callback=data_callback'
    ]
    ...
    def parse(self, response):
        ...
        if not response_body.strip().startswith('data_callback'):
            ...
            item = NeteaseMoneyNewsDetailItem()
